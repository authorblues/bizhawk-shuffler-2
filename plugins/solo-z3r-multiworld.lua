...
plugin.name = "Solo ALTTP Multiworld"
...
plugin.description =
[[
	Intended to work with seeds generated by Aerinon's Z3 DoorRandomizer fork. Untested with keydropshuffle and shopsanity, so currently may or may not work. (https://github.com/aerinon/ALttPDoorRandomizer)
...
function plugin.on_game_load(data, settings)
	this_player_id = memory.read_s8(0x1861CF, "CARTROM")+1
